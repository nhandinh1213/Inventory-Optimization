...
## Abstract
In today's competitive retail landscape, effective inventory management is crucial for balancing product availability with minimizing costs. Issues like overstocking or stockouts can lead to high holding expenses or missed sales opportunities, affecting both profitability and customer loyalty. This project addresses these challenges by applying advanced data analysis techniques to optimize inventory management processes. After comparing forecasting models SARIMAX and Prophet, Prophet was selected for its superior accuracy in demand prediction. The study also calculates the Economic Order Quantity (EOQ), lead times; analyzes safety stock levels and determines reorder points to optimize ordering processes and minimize inventory costs. The findings of this study reveal significant opportunities to reduce excess inventory, improve product availability, and enhance overall supply chain efficiency. By implementing the proposed data-driven strategies, retailers canstreamline operations, reduce costs, and deliver superior customer experiences.
## Business problems
